...
END
GO
IF NOT EXISTS (select 1 from [X_UIControl_Settings] where [ControlID] = 24 AND [varKey] =  N'FamilyStatusShowIncreasesTaxDeductible' )
BEGIN
...
END
GO
IF NOT EXISTS (select 1 from [X_UIControl_Settings] where [ControlID] = 24 AND [varKey] =  N'FamilyStatusShowEmployeeDependent' )
BEGIN
	INSERT INTO [dbo].[X_UIControl_Settings] ([ID], [ControlID], [varKey], [varValue]) VALUES (100, 24, N'FamilyStatusShowEmployeeDependent', N'1')
END
GO
...
---------------------------------------------X_App -----------------------------------------
GO
UPDATE X_App SET VERSION = '18.2.3.3'
PRINT 'Update X_App Scripts finished 18.2.3.3 Version'
